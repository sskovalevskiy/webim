...
public class Constants {
    ...
    public static final String E_MAIL = "o@webim.ru";
    public static final String PASSWORD = "password";

    public static final String PATH_TO_FILE = System.getProperty("user.dir") + "/src/main/resources/testFile.txt";

    public static final String SEND_TEXT = "Hello!";
